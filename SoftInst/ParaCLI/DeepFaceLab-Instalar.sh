...
# ----------
# Script de NiPeGun para instalar DeepFaceLab en Debian
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/DeepFaceLab-Instalar.sh | bash
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/DeepFaceLab-Instalar.sh | nano -
# ----------
...
# Ejecutar comandos dependiendo de la versión de Debian detectada
  ...
  if [ $cVerSO == "13" ]; then
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 13 (x)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 12 (Bookworm)...${cFinColor}"
    echo ""
    ...
    # Crear el menú
      ...
      menu=(dialog --checklist "Marca como quieres instalar la herramienta:" 22 70 16)
        opciones=(
          1 "Clonar el repo de DeepFaceLab"                                   on
...
# python3 main.py extract --input-dir workspace/data_src --output-dir workspace/data_src/aligned
              ...
              # Clonar el repo
                ...
                cd ~/repos/python/
                rm -rf ~/repos/python/DeepFaceLab/
            ...
            2)
              ...
              # Crear el mensaje para mostrar cuando se entra al entorno virtual
                echo 'echo -e "\n  Activando el entorno virtual de DeepFaceLab... \n"' >> ~/repos/python/DeepFaceLab/venv/bin/activate
              # Entrar al entorno virtual
                source ~/repos/python/DeepFaceLab/venv/bin/activate
              ...
              # Notificar fin de instalación en el entorno virtual
                echo ""
                echo -e "${cColorVerde}    Entorno virtual preparado. DeepFaceLab se puede ejecutar desde el venv de la siguiente forma:${cFinColor}"
                echo ""
                echo -e "${cColorVerde}      source ~/repos/python/DeepFaceLab/venv/bin/activate${cFinColor}"
                echo ""
                echo -e "${cColorVerde}        DeepFaceLab [Parámetros]${cFinColor}"
                echo ""
            ...
            3)
              ...
              # Compilar
                pyinstaller --onefile --collect-all=DeepFaceLab DeepFaceLab.py

              # Copiar el binario a /usr/bin
                mkdir ~/bin/
                cp -f ~/repos/python/DeepFaceLab/dist/DeepFaceLab ~/bin/
              ...
              # Notificar fin de ejecución del script
                echo ""
                echo "  El script ha finalizado. DeepFaceLab se ha descargado, compilado e instalado."
                echo ""
                echo "    Puedes encontrar el binario en ~/bin/DeepFaceLab"
                echo ""
                echo "  El binario debe ser usado con precaución. Es mejor correr el script directamente con python, de la siguiente manera:"
                echo ""
                echo "    source ~/PythonVirtualEnvironments/DeepFaceLab/bin/activate"
                echo "    python3 ~/scripts/python/DeepFaceLab/analyzeMFT.py [Argumentos]"
                echo "    deactivate"
                echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 11 (Bullseye)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 10 (Buster)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 9 (Stretch)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 8 (Jessie)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de DeepFaceLab para Debian 7 (Wheezy)...${cFinColor}"
    echo ""
