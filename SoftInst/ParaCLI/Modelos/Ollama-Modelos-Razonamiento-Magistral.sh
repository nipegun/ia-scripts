...
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-Modelos-Razonamiento-Magistral.sh | bash
#
# Ejecución remota (como root):
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-Modelos-Razonamiento-Magistral.sh | 's-sudo--g' | bash
# ----------
      ...
      do
        case $choice in
          ...
          1)
            ...
            echo ""
            echo "  Instalando magistral:24b-small-2506-q4_K_M..."
            echo ""
            ...
            # Comprobar si hay espacio libre disponible
              if [ "$vEspacioLibre" -ge "$vEspacioNecesario" ]; then
                ...
                echo ""
                echo -e "${cColorRojo}    No hay suficiente espacio libre para instalar el modelo magistral:24b-small-2506-q4_K_M.${cFinColor}"
                echo ""
          ...
          2)
            ...
            echo ""
            echo "  Instalando magistral:24b-small-2506-q8_0..."
            echo ""

            # Definir el espacio libre necesario
              vGBsLibresNecesarios=26
              vEspacioNecesario=$(($vGBsLibresNecesarios * 1024 * 1024)) # Convertir a kilobytes (1GB = 1048576KB)
            ...
            # Comprobar si hay espacio libre disponible
              if [ "$vEspacioLibre" -ge "$vEspacioNecesario" ]; then
                ...
                echo ""
                echo -e "${cColorRojo}    No hay suficiente espacio libre para instalar el modelo magistral:24b-small-2506-q8_0.${cFinColor}"
                echo ""
                echo -e "${cColorRojo}      Hacen falta $vGBsLibresNecesarios GB y hay sólo $vGBsLibres GB.${cFinColor}"
                echo ""
              fi
          ...
          3)
            ...
            echo ""
            echo "  Instalando magistral:24b-small-2506-fp16..."
            echo ""

            # Definir el espacio libre necesario
              vGBsLibresNecesarios=48
              vEspacioNecesario=$(($vGBsLibresNecesarios * 1024 * 1024)) # Convertir a kilobytes (1GB = 1048576KB)
            ...
            # Comprobar si hay espacio libre disponible
              if [ "$vEspacioLibre" -ge "$vEspacioNecesario" ]; then
                ollama pull magistral:24b-small-2506-fp16
              else
                echo ""
                echo -e "${cColorRojo}    No hay suficiente espacio libre para instalar el modelo magistral:24b-small-2506-fp16.${cFinColor}"
                echo ""
                echo -e "${cColorRojo}      Hacen falta $vGBsLibresNecesarios GB y hay sólo $vGBsLibres GB.${cFinColor}"
                echo ""
              fi
