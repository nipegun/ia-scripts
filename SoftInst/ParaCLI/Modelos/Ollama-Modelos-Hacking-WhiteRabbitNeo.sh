...
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-Hacking-WhiteRabbitNeo.sh | bash
#
# Ejecución remota como root:
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-Hacking-WhiteRabbitNeo.sh | sed 's-sudo--g' | bash
# ----------
      ...
      do
        case $choice in
          ...
          1)
            ...
            echo ""
            echo "  Instalando monotykamary/whiterabbitneo-v1.5a:7b..."
            echo ""
            ...
            # Comprobar si hay espacio libre disponible
              if [ "$vEspacioLibre" -ge "$vEspacioNecesario" ]; then
                ollama pull monotykamary/whiterabbitneo-v1.5a:7b
              else
                echo ""
                echo -e "${cColorRojo}    No hay suficiente espacio libre para instalar el modelo monotykamary/whiterabbitneo-v1.5a:7b.${cFinColor}"
                echo ""
          ...
          2)
            ...
            echo ""
            echo "  Instalando jimscard/whiterabbit-neo:13b..."
            echo ""
            ...
            # Comprobar si hay espacio libre disponible
              if [ "$vEspacioLibre" -ge "$vEspacioNecesario" ]; then
                ollama pull jimscard/whiterabbit-neo:13b
              else
                echo ""
