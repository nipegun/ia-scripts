...
# ----------
# Script de NiPeGun para instalar y configurar los diferentes modelos LLM de Llama para Ollama en Debian
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-Modelos-LLM-Llama.sh | bash
# ----------
...
# Crear el menú
  menu=(dialog --checklist "Marca los modelos que quieras instalar:" 22 96 16)
    opciones=(
     ...
     17 "llama4:17b-scout-16e-instruct-q8_0       (1M tokens)   (  x,x GB en disco) (x,x GB en RAM/VRAM)" off
     ...
     12 "llama3.2:3b-instruct-fp16                (128K tokens) (  6,6 GB en disco) (7,3 GB en RAM/VRAM)" off
      ...
      6 "llama3.1:405b-instruct-fp16              (128K tokens) (815,0 GB en disco) (x,x GB en RAM/VRAM)" off
