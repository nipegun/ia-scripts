...
# ----------
# Script de NiPeGun para instalar y configurar los diferentes modelos de DeepSeek en Ollama para Debian
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-DeepSeek.sh | bash
#
# Ejecución remota como root:
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Modelos/Ollama-DeepSeek.sh | sed 's-sudo--g' | bash
# ----------
