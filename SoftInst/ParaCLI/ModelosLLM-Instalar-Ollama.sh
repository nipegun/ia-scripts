...
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/ModelosLLM-Instalar-Ollama.sh | bash -s Parámetro1 Parámetro2
# ----------
