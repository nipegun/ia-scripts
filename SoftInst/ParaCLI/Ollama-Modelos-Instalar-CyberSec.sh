...
# ----------
# Script de NiPeGun para instalar y configurar los diferentes modelos de ciberseguridad para Ollama en Debian
#
# Ejecución remota (Puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Ollama-Modelos-Instalar-CyberSec.sh | bash
#
# Ejecución remota como root (Para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/ia-scripts/refs/heads/main/SoftInst/ParaCLI/Ollama-Modelos-Instalar-CyberSec.sh | sed 's-sudo--g' | bash
# ----------
