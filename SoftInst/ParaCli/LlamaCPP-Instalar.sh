...
# Notificar fin de ejecución del script
  ...
  echo ""
  echo "      ~/Soft/IA/LlamaCPP/llama-cli -m ~/Soft/IA/Modelos/Llama-3.2-3B-Instruct-Q8_0.gguf -p 'Hazme un script de python que diga hola?' -no-cnv"
  echo ""
  echo "      Podemos hacer que cierre la conversación, aunque no responda por completo, limitando el nro de tokens de respuesta:"
  echo ""
  echo "        ~/Soft/IA/LlamaCPP/llama-cli -m ~/Soft/IA/Modelos/Llama-3.2-3B-Instruct-Q8_0.gguf -p 'Hazme un script de python que diga hola?' -n 128 -no-cnv"
  echo ""
  echo "    Para ejecutar en modo conversación:"
  echo ""
  echo "      ~/Soft/IA/LlamaCPP/llama-cli -m ~/Soft/IA/Modelos/Llama-3.2-3B-Instruct-Q8_0.gguf"
  echo ""
  ...
  echo ""
  echo "        ~/Soft/IA/LlamaCPP/llama-server --port 9000 -m ~/Soft/IA/Modelos/Llama-3.2-3B-Instruct-Q8_0.gguf -c 16384 -np 4"
  echo ""
